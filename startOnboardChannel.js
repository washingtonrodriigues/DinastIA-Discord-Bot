...
export async function startOnboardingChannel(guild) {
  ...
  let onboardingChannel = guild.channels.cache.find(
    (c) => ['🚀-comece-aqui', '🚀｜comece-aqui'].includes(c.name) && c.parentId === category.id
  );
  ...
  if (!onboardingChannel) {
    ...
    .setImage('https://i.imgur.com/9vl05VP.jpg')
    .setFooter({ text: 'DinastIA - Bem-vindo à sua jornada!', iconURL: 'https://i.imgur.com/5w4E5TO.png' });
